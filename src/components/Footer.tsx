        ...
        <div className="grid gap-8 md:gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-3 text-sm leading-relaxed text-neutral-400">
              Centro odontológico integral. Especialistas en cada tratamiento,
              atención personalizada y diagnóstico honesto.
            </p>
            <p className="mt-4 text-xs text-neutral-500">
              Respondemos rápido. Escribinos y te damos turno.
            </p>
          </div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              {contact.hours.map((h) => (
                <li key={h.days} className="flex justify-between">
                  <span>{h.days}</span>
                  <span className="text-neutral-200">{h.time}</span>
                </li>
              ))}
            </ul>
